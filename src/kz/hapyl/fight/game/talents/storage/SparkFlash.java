...
public class SparkFlash extends Talent {
	public SparkFlash() {
		super("Blinding Fire", "Throw an energy blast filled with blinding energy that curves up and explodes after a short delay blinding anyone who line of sight with it.", Type.COMBAT);
