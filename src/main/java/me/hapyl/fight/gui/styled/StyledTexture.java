...
public class StyledTexture implements StyledBuilder {
    ...
    public static final StyledTexture ICON_WORDLE_STATISTICS = new StyledTexture(
            Material.FILLED_MAP, "Statistics", """
                                               See detailed statistics of your wordle journey!
                                               """
    );
    
    public static final StyledTexture LOADING = new StyledTexture(
            "d761ea71913137eb986ed861d1a9da1c70022ab5acd57b88499ab80cc4e0bd24",
            "&eLoading...", null
    );
    
    public static final StyledTexture ICON_GUESS_WHO = new StyledTexture(
            "413e96df6ed4b70a5a70fc29dcde9314dbe976696474f120e0b30ea5d7b96b3a",
            "Guess Who",
            null
    );
    ...
    public String texture() {
        return Objects.requireNonNull(texture, "Not texture!");
    }
