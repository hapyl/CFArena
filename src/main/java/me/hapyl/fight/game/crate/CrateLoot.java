...
public final class CrateLoot {
    ...
    public void createLoot() {
        ...
        final ItemContents<Cosmetic> contents = crate.getContents();
        ...
        if (isNew) {
            ...
            database.currencyEntry.add(Currency.COINS, randomItem.getRarity().getCompensation());
