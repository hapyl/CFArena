...
public abstract class Hero
    ...
    public void talk(@Nonnull GamePlayer player, @Nonnull String message) {
        talkBehaviour.talk(player, message);
    }
    ...
    public UltimateTalent getUltimate() {
        Catchers.catchNull(ultimate, "Ultimate MUST be set for %s!".formatted(name));
        return ultimate;
    }
     ...
     * @implNote Prefer returning the actual talent class instead of the base {@link Talent}.
     */
    ...
    @Nullable
    public ItemStack getTalentItem(@Nonnull Player player, @Nonnull HotBarSlot slot) {
