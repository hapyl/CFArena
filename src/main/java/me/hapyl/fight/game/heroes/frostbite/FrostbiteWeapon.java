...
public class FrostbiteWeapon extends RangeWeapon {
    ...
    @DisplayField private final double speedReduction = -10;
    @DisplayField private final double fatigueIncrease = 100;
    
    private final ModifierSource modifierSource = new ModifierSource(Key.ofString("frostbite_weapon"));
        ...
        return new ProjectileRayCast(this, player, 0.7d, 2) {
            ...
            public void onHit(@Nonnull LivingGameEntity entity, boolean isHeadShot) {
                ...
                entity.getAttributes().addModifier(
                        modifierSource, slowingAuraDuration, player, modifier -> modifier
                                .of(AttributeType.FATIGUE, ModifierType.FLAT, fatigueIncrease)
