...
public class MoonBase extends GameMap {
    ...
    public MoonBase() {
        ...
        addLocation(1905, 82, 1921, -180, 0);
        addLocation(1922, 73, 1860);
        addLocation(1895, 76, 1927, -90, 0);
        addLocation(1936, 75, 1897, 90, 0);
        addLocation(1890, 73, 1905, -90, 0);
        addLocation(1929, 73, 1937, -180, 0);
        addLocation(1908, 73, 1882);
