 ...
 */
public class MultiPartCommissionEntity extends CommissionEntity {

    private final Set<Part<?>> parts;

    public MultiPartCommissionEntity(@Nonnull CommissionEntityType type, @Nonnull LivingEntity entity) {
        super(type, entity);
    ...
    public class Part<E extends LivingEntity> extends LivingGameEntity {
        ...
        public LivingGameEntity getGameEntity() {
            return MultiPartCommissionEntity.this;
        }
