...
import me.hapyl.fight.game.talents.StaticTalentFormat;
...
public class Weapon
        ...
        ElementHandler, PlayerElementHandler, ItemCreator,
        Keyed {
    ...
    public void give(@Nonnull GamePlayer player) {
        player.setItem(HotBarSlot.WEAPON, createItem());
    }
    
    public void give(@Nonnull LivingGameEntity entity) {
        final EntityEquipment equipment = entity.getEquipment();
        
        equipment.setItemInMainHand(createItem());
    }
    ...
    public ItemBuilder createBuilder() {
        ...
        // TODO @Apr 25, 2025 (xanyjl) -> Item lore
        ...
        abilities.forEach((type, ability) -> {
            ...
            description = StaticTalentFormat.COOLDOWN.format0(description, ability);
            description = StaticTalentFormat.DURATION.format0(description, ability);
