...
public class DamageResonance extends TotemResonance {
    ...
    protected DamageResonance() {
        super(
                ...
                "Damage Aura",
                """
                Periodically deals &cdamage&7 to nearby &cenemies&7.
                """
        );
    ...
    public void resonate(@Nonnull Totem totem) {
        ...
        Collect.nearbyEntities(location, damageRadius, player::isNotSelfOrTeammate)
               .forEach(entity -> {
                   entity.damageNoKnockback(damage, player, DamageCause.TOTEM);
               });
