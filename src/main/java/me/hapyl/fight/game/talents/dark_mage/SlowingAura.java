...
public class SlowingAura extends DarkMageTalent {
    ...
    @DisplayField private final double fatigueIncrease = 50;
    ...
    private final ModifierSource modifierSource = new ModifierSource(Key.ofString("slowing_aura"));
    ...
    public SlowingAura(@Nonnull Key key) {
        super(
                key, "Slowing Aura", """
                                     ...
                                     """.formatted(AttributeType.FATIGUE)
        );
        ...
        new TimedGameTask(this) {
            ...
            public void run(int tick) {
                ...
                Collect.nearbyEntities(location, radius).forEach(entity -> {
                    ...
                    entity.addPotionEffect(PotionEffectType.SLOWNESS, 3, 10);
                    entity.getAttributes().addModifier(modifierSource, impairDuration, player, modifier -> modifier.of(AttributeType.FATIGUE, ModifierType.FLAT, fatigueIncrease));
