...
public class WitherRosePath extends Talent {
    ...
    @DisplayField(scale = 100) private final double maxHealthDecrease = -0.1;
    @DisplayField(scale = 100) private final double energyRechargeDecrease = -50;
    ...
    private final ModifierSource modifierSource = new ModifierSource(Key.ofString("nyx"), true);
    ...
    public WitherRosePath(@Nonnull Key key) {
        ...
        setDescription("""
                       ...
                       &8&o;;Gain one %s stack for each hit enemy.
                       """.formatted(AttributeType.MAX_HEALTH, AttributeType.ENERGY_RECHARGE, Named.THE_CHAOS.getName())
        );
               ...
               .forEach(entity -> {
                   ...
                   entity.getAttributes().addModifier(
                           modifierSource, impairDuration, player, modifier -> modifier
                                   .of(AttributeType.MAX_HEALTH, ModifierType.ADDITIVE, maxHealthDecrease)
                                   .of(AttributeType.ENERGY_RECHARGE, ModifierType.FLAT, energyRechargeDecrease)
                   );
