...
public class SlimeParkourEnjoyer extends PersistentNPC {
    public SlimeParkourEnjoyer() {
        super(3.5, 62, 22.5, 90.0f, 0.0f, "Undead Watcher");
    ...
    public void onClick(@Nonnull Player player) {
        ...
        if (fails > 0) {
            sendMessage(player, StringRandom.of(
            ...
            sendMessage(player, "No one has died yet here, could you be the first one?");
        }
    }
}
