...
public class CommissionerNPC extends PersistentNPC {
    ...
    public CommissionerNPC(@Nonnull Key key) {
        super(
                key, -6.5d, 62.0d, -11.5d, Component.text("Commissioner", Color.RED), Skin.of(
        ...
        getAppearance(AppearanceHumanoid.class)
                .setEquipment(Equipment.builder()
    ...
    public void tick() {
        ...
        if (nearestPlayer != null) {
            lookAt(nearestPlayer.getLocation());
        }
        // Else shake head
        else {
