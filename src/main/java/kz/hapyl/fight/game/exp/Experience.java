...
import kz.hapyl.fight.game.database.entry.ExperienceEntry;
import kz.hapyl.fight.game.reward.ExpLevelUpReward;
import kz.hapyl.fight.game.reward.Reward;
...
public class Experience {
    ...
    private ExperienceEntry getDatabaseEntry(Player player) {
        return Database.getDatabase(player).getExperienceEntry();
    }
